...
public class CalcPage extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	public void add(long l1, long l2){
		...
		new QAFExtendedWebElement("").isDisplayed();
		DeviceUtils.getQAFDriver().findElement(By.xpath("//*[@resource-id=\"com.sec.android.app.popupcalculator:id/bt_06\"]")).click();
		plusBtn.click();
		//DriverUtils.getAppiumDriver().findElementByAccessibilityId(String.valueOf(l2)).click();
		DeviceUtils.getQAFDriver().findElement(By.xpath("//*[@resource-id=\"com.sec.android.app.popupcalculator:id/bt_09\"]")).click();
		equalBtn.click();
	}
